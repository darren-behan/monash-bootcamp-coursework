...
// bind() can be used for "this" to refer to the specific object, rather than the "window" or "Timeout"
...
var person = {
  ...
  saySomething: function() {
    console.log(this.name + " is thinking...");
    // check what is the current "this" keyword
    // bind "this" keyword into the function
